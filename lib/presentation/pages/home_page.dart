import 'package:cat_tinder_pro/presentation/blocs/cat_bloc.dart';
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const LikedCatsPage()),
              );
            },
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () => context.read<CatBloc>().add(OnDislikeCat(cat : state.cat)),
                ),
                const SizedBox(width: 20),
                IconButton(
                  icon: const Icon(Icons.thumb_up, color: Colors.green),
                  onPressed: () => context.read<CatBloc>().add(OnLikeCat(cat : state.cat)),
                ),
              ],
            ),
